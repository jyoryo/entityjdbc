...
public class NamedThreadFactory implements ThreadFactory {
	...
	public NamedThreadFactory(String prefix, ThreadGroup threadGroup, boolean isDeamon, UncaughtExceptionHandler handler) {
		this.prefix = Strings.isBlank(prefix) ? "jyoryo" : prefix;
		if (null == threadGroup) {
			threadGroup = Threads.currentThreadGroup();
		}
	...
	public Thread newThread(Runnable r) {
		final Thread t = new Thread(this.group, r, Strings.format("{}{}", prefix, threadNumber.getAndIncrement()));
