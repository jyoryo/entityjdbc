...
public class Chars extends CharUtils {
	...
	public static final String [] ASCII_STRING = new String[ASCII_LENGTH];
	...
	static {
		for(char c = 0; c < ASCII_LENGTH; c ++) {
			ASCII_STRING[c] = String.valueOf(c);
		}
	}
	...
	public static String toString(char c) {
		return c < ASCII_LENGTH ? ASCII_STRING[c] : String.valueOf(c);
	}
	...
	public static boolean isEmoji(char c) {
		return false ==  ((c == 0x0) || (c == 0x9) || (c == 0xA) || (c == 0xD) || ((c >= 0x20) && (c <= 0xD7FF)) || ((c >= 0xE000) && (c <= 0xFFFD)) || ((c >= 0x10000) && (c <= 0x10FFFF)));
	}
