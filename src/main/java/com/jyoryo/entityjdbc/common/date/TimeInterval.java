package com.jyoryo.entityjdbc.common.date;

import com.jyoryo.entityjdbc.Dates;
...
public class TimeInterval {
	...
	public long interval() {
		return Dates.current(isNano) - time;
	}
